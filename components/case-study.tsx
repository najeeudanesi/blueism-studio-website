    ...
    <article style={{ backgroundColor: 'var(--background)', color: 'var(--foreground)', minHeight: '100vh', paddingBottom: '4rem' }}>
      ...
      <header style={{
        ...
        <Link href="/" style={{ textDecoration: 'none', display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
          <div style={{ width: '28px', height: '28px', backgroundColor: '#0000FF', overflow: 'hidden' }}>
            <Image src="/logo.png" alt="Blueism logo" width={28} height={28} style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
          </div>
          <span style={{ fontFamily: 'var(--font-bold)', fontSize: '0.9rem', fontWeight: 700, color: 'var(--foreground)', letterSpacing: '0.1em', textTransform: 'uppercase' }}>
            Blueism
          </span>
        </Link>
      ...
      <div style={{ maxWidth: '1400px', margin: '0 auto', padding: '100px 2rem 4rem' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: '2rem', borderBottom: '1px solid var(--border)', paddingBottom: '1rem' }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.25rem' }}>
            <span style={{ fontFamily: 'var(--font-mono)', fontSize: '0.6rem', letterSpacing: '0.2em', textTransform: 'uppercase', color: '#0000FF' }}>
              {project.discipline}
            </span>
            <h1 style={{
        ...
        >
          ...
          <div style={{ position: 'absolute', bottom: 0, left: 0, width: '24px', height: '24px', backgroundColor: '#0000FF' }} />
        </motion.div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '2.5rem' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '2.5rem', marginTop: '1.5rem' }} className="pillars-grid">
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                <span className="label" style={{ color: '#0000FF' }}>[ The Challenge ]</span>
                <p style={{ fontFamily: 'var(--font-sans)', fontSize: '0.9rem', fontWeight: 300, lineHeight: 1.8, color: 'var(--secondary)', margin: 0 }}>
                  {project.challenge}
                </p>
              </div>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                <span className="label" style={{ color: '#0000FF' }}>[ The Approach ]</span>
                <p style={{ fontFamily: 'var(--font-sans)', fontSize: '0.9rem', fontWeight: 300, lineHeight: 1.8, color: 'var(--secondary)', margin: 0 }}>
                  {project.approach}
                </p>
              </div>
            ...
            <div style={{ borderTop: '1px solid var(--border)', paddingTop: '1.5rem', marginTop: '1rem' }}>
              <span className="label" style={{ color: '#0000FF', display: 'block', marginBottom: '0.5rem' }}>[ The Result ]</span>
        ...
        <section id="contact-project" style={{ backgroundColor: '#0000FF', color: 'white', padding: '5rem 3rem', position: 'relative', overflow: 'hidden', marginBottom: '5rem' }}>
          {/* Grain overlay */}
          <div style={{
